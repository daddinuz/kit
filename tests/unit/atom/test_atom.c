...
FeatureDefine(AtomEssentials) {
...

    {
        ...
        kit_Atom atom1 = ImmutableOption_unwrap(kit_Atom_put(EXPECTED_TEXT, EXPECTED_LENGTH));
        kit_Atom atom2 = ImmutableOption_unwrap(kit_Atom_fromLiteral(EXPECTED_TEXT));
...

    {
        ...
        kit_Atom atom = ImmutableOption_unwrap(kit_Atom_fromInteger(SEED));
...

    {
        ...
        kit_Atom atom = ImmutableOption_unwrap(kit_Atom_fromFloating(SEED));
