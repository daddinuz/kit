...
extern OptionOf(void *) __kit_Allocator_malloc(const char *file, int line, size_t size);
extern OptionOf(void *) __kit_Allocator_calloc(const char *file, int line, size_t numberOfMembers, size_t memberSize);
extern OptionOf(void *) __kit_Allocator_ralloc(const char *file, int line, void *ptr, size_t newSize);
extern OptionOf(void *) __kit_Allocator_copy(const char *file, int line, void *dst, const void *src, size_t size);
extern OptionOf(void *) __kit_Allocator_move(const char *file, int line, void *dst, const void *src, size_t size);
extern OptionOf(void *) __kit_Allocator_set(const char *file, int line, void *ptr, int value, size_t size);
